...
export default function LeaderboardTable({ rows }: { rows: LeaderboardRow[] }) {
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 max-h-[70vh] flex flex-col">
      {rows && rows.length > 0 ? (
        <>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-2 py-4 text-center text-xs font-bold text-gray-900">+/-</th>
                  <th className="px-3 py-4 text-right text-xs font-bold text-gray-900">Score</th>
                </tr>
              </thead>
            </table>
          </div>
